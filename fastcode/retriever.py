...
from .utils import ensure_dir, log_retrieval_results, set_verbose_logging, is_verbose_logging
...
class HybridRetriever:
    ...
    def __init__(self, config: Dict[str, Any], vector_store: VectorStore,
        ...
        # Initialize verbose logging from config
        log_config = config.get("logging", {})
        verbose = log_config.get("verbose", False)
        set_verbose_logging(verbose)
        self.logger.info(f"Verbose logging: {verbose}")
    ...
    def retrieve(self, query: Union[str, ProcessedQuery], filters: Optional[Dict[str, Any]] = None,
        ...
        # Log retrieval results if verbose logging is enabled
        log_retrieval_results(query_str, final_results)
